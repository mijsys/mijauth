...
class MijAuth {
  ...
  static Future<bool> verifyAuthFileWithToken(
    ...
    return timingSafeEquals(expectedToken, payload['token'] as String) &&
        timingSafeEquals(expectedUserId, payload['user_id'] as String);
  }
  ...
  static Future<bool> verifyAuthFileWithTokenAndDevice(
    ...
    if (!timingSafeEquals(expectedToken, payload['token'] as String) ||
        !timingSafeEquals(expectedUserId, payload['user_id'] as String)) {
      return false;
    }
    ...
    if (expectedDeviceHash != null) {
      if (!payload.containsKey('device_hash') ||
          !timingSafeEquals(expectedDeviceHash, payload['device_hash'] as String)) {
        return false;
      }
    }
    ...
    if (expectedDeviceHashV2 != null) {
      if (!payload.containsKey('device_hash_v2') ||
          !timingSafeEquals(expectedDeviceHashV2, payload['device_hash_v2'] as String)) {
        return false;
      }
    }
